...
<p align="center">
  <img src="docs/images/chatmux-mobile-terminal.jpg" alt="ChatMux 移动端终端操作截图" width="320"><br>
  <strong>真实终端主界面</strong><br>
  <sub>快捷键、命令输入、上下文和终端恢复都放在手机主工作流里。</sub>
</p>

<p align="center">
  <img src="docs/images/chatmux-mobile-sessions.jpg" alt="ChatMux 移动端会话列表截图" width="320"><br>
  <strong>会话列表</strong><br>
  <sub>查看 tmux session 状态，开启 session alerts，快速创建新会话。</sub>
</p>

<p align="center">
  <img src="docs/images/chatmux-mobile-windows.jpg" alt="ChatMux 移动端窗口列表截图" width="320"><br>
  <strong>窗口管理</strong><br>
  <sub>在移动端切换 tmux window，管理每个 session 里的多窗口工作。</sub>
</p>

<p align="center">
  <img src="docs/images/chatmux-mobile-hosts.jpg" alt="ChatMux 移动端主机管理截图" width="320"><br>
  <strong>主机与 Gateway</strong><br>
  <sub>管理 Gateway Token、SSH Host、凭据状态和移动端安全解锁。</sub>
</p>
